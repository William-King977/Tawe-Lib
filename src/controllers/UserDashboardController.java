...
public class UserDashboardController {
	...
	public void handleBorrowedItemsButtonAction() {
		...
		try {
			...
			Parent root = FXMLLoader.load(getClass()
					.getResource(Main.FXML_FILE_PATH + "BorrowedItems.fxml"));
	...
	public void handleRequestedItemsButtonAction() {
		...
		try {
			Stage primaryStage = new Stage();
			Parent root = FXMLLoader.load(getClass()
					.getResource(Main.FXML_FILE_PATH + "RequestedItems.fxml"));
			Scene scene = new Scene(root);
			primaryStage.setScene(scene);
	...
	public void handleReservedItemsButtonAction() {
		...
		try {
			Stage primaryStage = new Stage();
			Parent root = FXMLLoader.load(getClass()
					.getResource(Main.FXML_FILE_PATH + "ReservedItems.fxml"));
			Scene scene = new Scene(root);
			primaryStage.setScene(scene);
    ...
    public void handleTransactionHistoryButtonAction() {
		...
		try {
			Stage primaryStage = new Stage();
			Parent root = FXMLLoader.load(getClass()
					.getResource(Main.FXML_FILE_PATH + "TransactionHistory.fxml"));
			Scene scene = new Scene(root);
			primaryStage.setScene(scene);
	...
	public void handleViewResourcesButtonAction() {
		...
		try {
			Stage primaryStage = new Stage();
			Parent root = FXMLLoader.load(getClass()
					.getResource(Main.FXML_FILE_PATH + "ViewResource.fxml"));
			Scene scene = new Scene(root);
			primaryStage.setScene(scene);
