...
public class Copy implements Comparable<Copy> {
	...
	/**
	 * Comparison method used to sort the Copies in ascending order of copy ID.
	 * @param otherCopy The other copy object being compared.
	 * @return A positive integer if this > otherCopy, otherwise a negative integer.
	 */
	public int compareTo(Copy otherCopy) {
		return this.getCopyID() - otherCopy.getCopyID();
	}
}
